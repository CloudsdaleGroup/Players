...
var xhr = new XMLHttpRequest()
            xhr.open("GET", "https://code02.cloudsdaleradio.com/api/nowplaying/1", true)
            xhr.onreadystatechange = function(channel) {
                ...
                if(data["station"] === null){
                    ...
                    $('.navsong').text('Station Offline');
                }else{
                    var listen = data.listeners.current + 10;
                    //Now Playing
                    $('.song').html('Now Playing: <br> <strong> ' + data.now_playing.song.text + '</strong>');
        ...
        function checkUpdate(e) {
            $.getJSON("https://broadcaster.cloudsdaleradio.com/api/nowplaying/1",function(streamData) {
